// src/entities/recipe/model/mockDetailRecipes.ts
// 레시피 상세 페이지용 더미 데이터.
// API 연동 시 삭제 예정 — id는 SearchPage recipeId와 일치.

import type { Recipe } from "./recipe.types";

export const MOCK_DETAIL_RECIPES: Record<string, Recipe> = {
  "1": {
    id: "1",
    title: "김치찌개",
    ...
    steps: [
      ...
      },
      {
        ...
        duration: 10,
        imageUrl: "https://images.unsplash.com/photo-1760228865341-675704c22a5b?w=400",
      },
  ...
  "2": {
    ...
    calories: 580,
    description:
      "소금과 후추만으로 고기 본연의 맛을 살린 레스토랑 수준의 스테이크를 집에서 즐겨보세요.",
    ingredients: [
    ...
    steps: [
      {
        step: 1,
        description: "고기를 실온에 30분 꺼내두고 소금, 후추로 밑간합니다.",
        duration: 30,
      },
      {
        step: 2,
        description: "팬을 강불로 달군 후 올리브유를 두르고 고기를 올립니다.",
        duration: 4,
        imageUrl: "https://images.unsplash.com/photo-1708615017161-2eff302d0389?w=400",
      },
  ...
  "3": {
    ...
    calories: 420,
    description:
      "다채로운 나물과 고추장이 어우러진 전통 비빔밥. 냉장고 채소들을 모두 활용할 수 있어요.",
    ingredients: [
    ...
    steps: [
      {
        step: 1,
        description: "당근과 시금치를 각각 데쳐 참기름, 소금으로 무칩니다.",
        duration: 10,
      },
      {
        step: 2,
        description: "계란은 프라이로 반숙 상태로 만듭니다.",
        duration: 5,
        imageUrl: "https://images.unsplash.com/photo-1560100927-c32f29063ade?w=400",
      },
      { step: 3, description: "따뜻한 밥 위에 나물을 색깔 맞춰 둘러 담습니다.", duration: 3 },
      {
        step: 4,
        description: "가운데 달걀 프라이를 올리고 참기름을 둘러 비비면 완성입니다.",
        duration: 2,
      },
    ],
  },
  "4": {
    ...
    calories: 380,
    description:
      "당면과 다채로운 채소가 어우러진 잡채. 명절 단골 메뉴지만 평소에도 손색없는 별미입니다.",
    ingredients: [
      { name: "당근", amount: "1/2개", owned: true },
    ...
    steps: [
      ...
      {
        step: 2,
        description: "채소와 소고기를 각각 볶습니다.",
        duration: 15,
        imageUrl: "https://images.unsplash.com/photo-1583032015879-e5022cb87c3b?w=400",
      },
  ...
  "5": {
    ...
    steps: [
      ...
      {
        step: 2,
        description: "올리브유에 마늘을 볶다가 토마토를 넣고 소스를 만듭니다.",
        duration: 8,
        imageUrl: "https://images.unsplash.com/photo-1528751086790-81a64658fc53?w=400",
      },
      {
        step: 3,
        description: "소스에 삶은 파스타를 넣고 면수를 추가해 잘 섞어 완성합니다.",
        duration: 3,
      },
    ],
  },
  "6": {
    ...
    calories: 520,
    description:
      "진한 돈코츠 풍미의 라멘. 육수를 정성껏 끓이면 전문점 부럽지 않은 한 그릇이 완성됩니다.",
    ingredients: [
      { name: "돼지고기", amount: "150g", owned: true },
    ...
    steps: [
      ...
      {
        step: 2,
        description: "그릇에 면과 육수를 담습니다.",
        duration: 5,
        imageUrl: "https://images.unsplash.com/photo-1731460202531-bf8389d565f7?w=400",
      },
